...
int main() {
    ...
    // مسیر فایل مبدا
    std::string sourceFilePath = "output_include_rl.out";
    ...
    size_t projectPos = destinationContent.find("<name>CCIncludePath2</name>");
    ...
    destinationContent.insert(projectPos + sizeof("<name>CCIncludePath2</name>") - 1, "\n" + fileContent);
